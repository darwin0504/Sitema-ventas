        ...
        <nav class="navbar navbar-expand-   lg navbar-light bg-info">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a style="margin-left: 10px; border: none" class="btn-outline-light" href="Controlador?accion=productos" target="myFrame">Producto</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a  style="margin-left: 10px; border: none" class="btn-outline-light" href="Controlador?accion=registrarVenta"  target="myFrame">Nueva Venta</a>
                    </li>
                </ul>
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu text-center">
                        <a class="dropdown-item" href="#">
                            <img src="img/perfil.jpg"  class="img-fluid rounded-circle"/>
                        </a>
